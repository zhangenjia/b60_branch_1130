...
public class LinkManSyncingState implements ILinkManState{

    private static final String TAG = LinkManSyncingState.class.getSimpleName();
    ...
    public LinkManSyncingState(){}

    public LinkManSyncingState(List<View> viewList){
