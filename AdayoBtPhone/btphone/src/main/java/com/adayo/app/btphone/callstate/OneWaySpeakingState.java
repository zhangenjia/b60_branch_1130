 ...
 *单方通话-通话中
 */
public class OneWaySpeakingState implements ICallState {

    private static final String TAG = OneWaySpeakingState.class.getSimpleName();
    ...
    public OneWaySpeakingState(List<View> visibleList, List<TextView> textList){
    ...
    public void updateDisplayStatus() {
        ...
        if(mBTCallMgr.isCurrentWeChatCall()){
