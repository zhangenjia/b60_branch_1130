 ...
 *三方通话-拨号中
 */
public class ThirdWayGoState implements ICallState {

    private static final String TAG = ThirdWayGoState.class.getSimpleName();
    ...
    public ThirdWayGoState(List<View> visibleList, List<TextView> textList){
