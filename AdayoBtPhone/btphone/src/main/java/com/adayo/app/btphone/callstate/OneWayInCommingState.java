 ...
 *单方通话-来电中
 */
public class OneWayInCommingState implements ICallState {
    private static final String TAG = OneWayInCommingState.class.getSimpleName();
    ...
    public OneWayInCommingState(List<View> visibleList, List<TextView> textList){
