 ...
 *三方通话-切换通话后回调
 */
public class ThirdWayHoldState implements ICallState {

    private static final String TAG = ThirdWayHoldState.class.getSimpleName();
    ...
    public ThirdWayHoldState(List<View> visibleList, List<TextView> textList){
