...
public class LogUtil {
    ...
    private static final String FRAMEWORK_NET_WIFIAPCONFIGSTOREDEF = "/system/etc/adayo/AdayoPicture/AppAdayoPictureDef.json";
    ...
    private static  String close="false";
    ...
    private static String getDebuggable() {
        ...
        if (DebuggableJsonString == null) {
            Log.w("LogUtil", "/system/etc/adayo/AdayoPicture/AppAdayoPictureDef.json = null");
            return "false";
        }
        try {
    ...
    public static boolean isDebuggable() {
       if(DebuggableString==null){
         ...
         if(open.equals(DebuggableString)){
             Debuggable=true;
         }else if(close.equals(DebuggableString)){
             Debuggable=false;
         }else {
