...
public class ArtistFragment extends AbsFragment<FragmentMusicBrowseComponentBinding> {
    ...
    protected void initData() {
        ...
        mStateViewModel.getInfoRequest().getMetadataLoadingStateLiveData().observe(getViewLifecycleOwner(), aBoolean -> {
            if (aBoolean) {
                ...
                if (metadataInfo == null) {
                    mStateViewModel.getInfoRequest().requireArtistList(null);
                } else {
                    mStateViewModel.getInfoRequest().requireArtistList(metadataInfo.getId3Info().getArtistName());
                }
                ImageView ivLoading = mViewBinding.flStateHost.findViewById(R.id.iv_loading_ico);
                if (ivLoading != null) {
                    Drawable drawable = ivLoading.getDrawable();
        ...
        mStateViewModel.getInfoRequest().getArtistListLiveData().observe(getViewLifecycleOwner(), objects -> {
                ...
                public void onGlobalLayout() {
                    if (o instanceof FileInfo) {
                        ...
                        mHeaderAdapter.submitList(new ArrayList<String>() {{
                            add(fileInfo.getMetadataInfo().getId3Info().getArtistName());
                        }});
                    } else {
    ...
    protected void initEvent() {
        ...
        mEntityAdapter.setOnItemClickListener((view, position) -> {
            ...
            if (o instanceof String) {
                mStateViewModel.getInfoRequest().requireArtistList((String) o);
