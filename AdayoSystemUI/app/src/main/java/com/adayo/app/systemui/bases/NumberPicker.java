...
public class NumberPicker extends LinearLayout{
    ...
    public void scrollBy(int x, int y) {
        ...
        while (mCurrentScrollOffset - mInitialScrollOffset > mSelectorTextGapHeight) {
            ...
            Log.d(TAG, "scrollBy1=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
//            setValueInternal(selectorIndices[SELECTOR_MIDDLE_ITEM_INDEX], false);
        ...
        while (mCurrentScrollOffset - mInitialScrollOffset < -mSelectorTextGapHeight) {
            ...
            Log.d(TAG, "scrollBy2=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
//            setValueInternal(selectorIndices[SELECTOR_MIDDLE_ITEM_INDEX], true);
    ...
    public void setDisplayedValues(String[] displayedValues) {
        ...
        initializeSelectorWheelIndices();
        tryComputeMaxWidth();
        Log.d(TAG, "setDisplayedValues=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
    ...
    public static final String FAHRENHEIT_DISPLAY = "Fahrenheit_display";//温度单位状态获取关键字
    @Override
    protected void onDraw(Canvas canvas) {
    	Log.d(TAG, "mHasSelectorWheel= " + mHasSelectorWheel);
        if (!mHasSelectorWheel) {
            super.onDraw(canvas);
            return;
        }
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            // with the new one.
            mSelectorWheelPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(),"fonts/font_beijingauto_b60v_normal_v1.1.3.otf"));
            mSelectorWheelPaint.setColor(mSelectColor);
            if(scrollSelectorValue.equals("LO")){
                mSelectorWheelPaint.setColor(getResources().getColor(R.color.hvac_lo));
            }
            if(scrollSelectorValue.equals("HI")){
                mSelectorWheelPaint.setColor(getResources().getColor(R.color.hvac_hi));
            }

            if (SELECTOR_MIDDLE_ITEM_INDEX == i) {
//                mSelectorWheelPaint.setColor(mSelectColor);
                mSelectorWheelPaint.setAlpha(255);
            	mSelectorWheelPaint.setTextSize(getResources().getDimension(R.dimen.list_select_text_size_1));
            } else if (Math.abs(i - SELECTOR_MIDDLE_ITEM_INDEX) == 1){
//                mSelectorWheelPaint.setColor(mUnSelectColor);
                mSelectorWheelPaint.setAlpha(128);
            	mSelectorWheelPaint.setTextSize(getResources().getDimension(R.dimen.list_select_text_size_2));
            } else {
//                mSelectorWheelPaint.setColor(mUnSelectColor);
                mSelectorWheelPaint.setAlpha(128);
            	mSelectorWheelPaint.setTextSize(getResources().getDimension(R.dimen.list_select_text_size_3));
            }
//            int type = Settings.System.getInt(getContext().getContentResolver(), FAHRENHEIT_DISPLAY, -1);
//            if(!scrollSelectorValue.equals("LO") && !scrollSelectorValue.equals("HI") && type == 1){
//        		float temp = Float.parseFloat(scrollSelectorValue);
//        		float temperature = (temp*10*18f)/100f + 32;
//        		scrollSelectorValue = temperature + "";
//        	}
...
//            	mSelectorWheelPaint.setColor(mSelectColor);
//                canvas.drawText(scrollSelectorValue, x, y, mSelectorWheelPaint);
////                setValueInternal(selectorIndex, true);
//                
//            }
            Log.d(TAG, "onDraw=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX] + "---mSelectColor=" + mSelectColor);
    ...
    private void setValueInternal(int current, boolean notifyChange) {
    	Log.d(TAG, "setValueInternal=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
        if (mValue == current) {
            return;
        }
        Log.d(TAG, "setValueInternal1=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
    ...
    private void changeValueByOne(boolean increment) {
        ...
        Log.d(TAG, "changeValueByOne=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
    }
    ...
    private void notifyChange(int previous, int current) {
    	Log.d(TAG, "notifyChange=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
        if (mOnValueChangeListener != null) {
        	Log.d(TAG, "notifyChange=" + mValue + "----mSelectorIndices=" + mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
            mOnValueChangeListener.onValueChange(this, previous, mSelectorIndices[SELECTOR_MIDDLE_ITEM_INDEX]);
        }
    }
