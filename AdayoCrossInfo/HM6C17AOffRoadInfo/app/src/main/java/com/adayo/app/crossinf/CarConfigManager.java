...
public class CarConfigManager {
    private static final String TAG = CarConfigManager.class.getSimpleName();
    private static CarConfigManager mCarConfigManager;
    public static int CONSTANT_CONFIG = 1;
    ...
    public static CarConfigManager getInstance(Context context) {
        if (null == mCarConfigManager) {
            synchronized (CarConfigManager.class) {
                if (null == mCarConfigManager) {
                    mCarConfigManager = new CarConfigManager(context);
                }
            }
        }
        return mCarConfigManager;
    }


    private CarConfigManager(Context context) {
        ...
        Log.d(TAG, "CarConfigManager: "+" front_axle_lock = "+front_axle_lock+" rear_axle_lock = "+rear_axle_lock+" wading_induction_sys = "+wading_induction_sys);
    }
