...
import com.adayo.app.setting.viewmodel.fragment.Display.LowDisplayViewModel;
...
public class LowTimeFragment implements IFragmentConfig<TimeFragment, FragmentDisplayTimeBinding> {
    private final static String TAG = LowTimeFragment.class.getSimpleName();
    private LowDisplayViewModel mViewModel;
    private DateTimeSettingWindow DateTimeSettingWindow;
    private boolean mIs24HourClockMode;
    private DisplaySetHighlight mDisplaySetLowlight;
    ...
    public void bindData() {
        mViewModel = ViewModelProviders.of(fragment.requireActivity()).get(LowDisplayViewModel.class);
        mDisplaySetLowlight = ViewModelProviders.of(fragment.requireActivity()).get(DisplaySetHighlight.class);
    ...
    public void initView() {
        LogUtil.debugD(TAG, "");
        mViewBinding.tvDisplaySetTimeAuto.setVisibility(View.GONE);
        mViewBinding.tgBtnDisplaySetTimeAuto.setVisibility(View.GONE);
    ...
    public void initData() {
        ...
        mViewModel.mLowTimeRequest.get24ClockModeLiveData().observe(fragment.getViewLifecycleOwner(), new Observer<Boolean>() {
            @Override
        ...
        mViewModel.mLowTimeRequest.getTimeLiveData().observe(fragment.getViewLifecycleOwner(), new Observer<String>() {
            @Override
        ...
        mDisplaySetLowlight.mDisplaySetHighlightRequest.getDisplaySetHighlight().observe(fragment.getViewLifecycleOwner(), new Observer<Integer>() {
            @Override
    ...
    public void initEvent() {
        ...
        mViewBinding.sbDisplaySetTimeMode.setOnTabSelectListener(new OnTabSelectListener() {
            ...
            public void onTabSelect(int progress, boolean fromUser) {
                ...
                if (fromUser) {
                    mViewModel.mLowTimeRequest.request24ClockMode(progress == 0);
                    mDisplaySetLowlight.mDisplaySetHighlightRequest.requestHighlightModule(HIGHLIGHT_DISPLAY_SET_TIME);
                }
            }
        });
    ...
    private void initDateTimeSettingWindow(boolean is24HourClockMode) {
        ...
        DateTimeSettingWindow = new DateTimeSettingWindow(fragment.getActivity(), is24HourClockMode);DateTimeSettingWindow.setOnSaveButtonClickListener(new OnSaveButtonListener() {
            ...
            public void onSaveButtonClick(View view, Map<String, Integer> data) {
                ...
                mViewModel.mLowTimeRequest.requestTime(tyear, tmonth, tday, thour, tminute, 0);
            }
        });
    ...
    public void onStart() {
        LogUtil.debugD(TAG, "");
        mDisplaySetLowlight.mDisplaySetHighlightRequest.requestHighlightModule(HIGHLIGHT_NO);
